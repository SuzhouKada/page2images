 ...
 * set_jpeg_quality($x) - quality to wrte jpeg files in for save, default 90 (1-100)
...
class Image_moo
{
	...
	public function set_jpeg_quality($quality=90)
	//----------------------------------------------------------------------------------------------------------
	// Sets the quality that jpeg will be saved at
	//----------------------------------------------------------------------------------------------------------
	{
	...
	public function resize($mw, $mh=FALSE, $pad=FALSE,$isFixed=false)
	//----------------------------------------------------------------------------------------------------------
